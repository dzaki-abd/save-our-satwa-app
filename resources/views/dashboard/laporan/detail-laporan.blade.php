              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent pl-1">
                  <li class="breadcrumb-item">
                    <a class="text-success" href="/dashboard/laporan">Laporan</a>
                  </li>
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3 d-flex align-items-center">
                <h6 class="m-0 font-weight-bold text-success">
                  Edit Status Laporan dengan ID KAL121JWY
                </h6>
              </div>
              <div class="card-body"> 
                <form action="" method="" class="row g-3 align-items-center">
                  <div class="col-auto">
                  ...
                  <table class="table" width="100%" cellspacing="0">
                    <tbody>
                      ...
                      <tr class="align-middle">
                        <td colspan="2" class="align-middle text-gray-600 pl-0" style="border-top: 0">
                      ...
                      <tr class="align-middle">
                        <th class="pl-0" style="border-top: 0; max-width: 10rem;">Nama</th>
                        <td class="align-middle text-gray-600" style="border-top: 0">Kevin Iansyah</td>
                      </tr>
                      <tr class="align-middle">
                        <th class="pl-0" style="border-top: 0; max-width: 10rem;">Email</th>
                        <td class="align-middle text-gray-600" style="border-top: 0">keviniansyah13123@gmail.com</td>
                      </tr>
                      <tr class="align-middle">
                        <th class="pl-0" style="border-top: 0; max-width: 10rem;">Nomor Telepon</th>
                        <td class="align-middle text-gray-600" style="border-top: 0">083174908398</td>
                      </tr>
                      ...
                      <tr class="align-middle">
                        <th class="pl-0" style="border-top: 0; max-width: 10rem;">Tanggal Kejadian</th>
                        <td class="align-middle text-gray-600" style="border-top: 0">20 Februari 2022</td>
                      </tr>
                      <tr class="align-middle">
                        <th class="pl-0" style="border-top: 0; max-width: 10rem;">Lokasi Kejadian</th>
                        <td class="align-middle text-gray-600" style="border-top: 0">Jl. SoekarnoHatta, Kota Malang</td>
                      </tr>
                      ...
                      <tr class="align-middle">
                        <th class="pl-0" style="border-top: 0; max-width: 10rem;">Jenis Pelanggaran</th>
                        <td class="align-middle text-gray-600" style="border-top: 0">Predagangan Satwa Dilindungi</td>
                      </tr>
                      <tr class="align-middle">
                        <th class="pl-0" style="border-top: 0; max-width: 10rem;">Jenis Satwa</th>
                        <td class="align-middle text-gray-600" style="border-top: 0">Orang Utan</td>
                      </tr>
                      ...
                      <tr class="align-middle">
                        <td colspan="2" class="align-middle text-gray-600 pl-0" style="border-top: 0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates minima labore deleniti expedita assumenda itaque corrupti nisi iusto. Commodi cum nisi sequi totam temporibus iste odio expedita repellat suscipit exercitationem.</td>
                      </tr>
                      ...
                      <tr class="align-middle">
                        <td colspan="2" class="align-middle text-gray-600 pl-0" style="border-top: 0">
                          @for($i = 0; $i < 5; $i++)
                          <a href="../../../img/buktilaporan.jpg" data-fancybox="buktiLaporan" data-caption="Gallery B #2">
                            <img src="../../../img/buktilaporan.jpg" alt="" class="rounded mb-1" style="height: 200px">
                          </a>
                          @endfor
                        </td>
                      </tr>
                      ...
                      <tr class="align-middle">
                        <td  colspan="2" class="align-middle text-gray-600 pl-0" style="border-top: 0;">
                          <a href="../../../pdf/brosurIL.pdf" class="btn btn-success">Download pdf</a>
                        </td>
                      </tr>
