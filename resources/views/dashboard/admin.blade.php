      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <!-- DataTales Admin -->
            <div id="boxAdmin" class="card-2 shadow mb-4 bg-white">
              <div class="card-header py-3 d-flex align-items-center">
                <h6 class="m-0 font-weight-bold text-success">
                  Data Admin
                </h6>
                <!-- Button Trigger-->
                <button type="button" class="btn btn-success ml-3" data-bs-toggle="modal" data-bs-target="#tambahAdmin">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="adminDataTables" width="100%" cellspacing="0">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      <tr class="align-middle">
                        ...
                        <td class="d-flex align-middle">
                          <div class="d-flex">
                            <!-- Button Trigger-->
                            <button type="button" href="#" class="btn btn-danger d-flex justify-content-center align-items-center"  data-bs-toggle="modal" data-bs-target="#deleteAdmin" style="width: 30px; height: 30px">
