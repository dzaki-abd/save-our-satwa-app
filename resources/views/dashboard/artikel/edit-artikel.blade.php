              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent pl-1">
                  <li class="breadcrumb-item">
                    <a class="text-success" href="/dashboard/artikel">Artikel</a>
                  </li>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <select class="custom-select" id="type" name="type" required>
                          <option value="{{ $type = "Artikel" }}">Pilih...</option>
                    ...
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <select class="custom-select" id="show" name="show" required>
                          <option value="{{ $show = "True" }}">Pilih...</option>
                    ...
                    <div class="col">
                      <div class="mb-3">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="title" name="title" placeholder="Masukkan title" value="{{ $title = "Ternak Unta" }}"/>
                        </div>
                      </div>
                    </div>
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="published" name="published" placeholder="Tanggal terbit" value="{{ $published = "20/02/2020" }}"/>
                      </div>
                    </div>
                  </div>
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="keyword" name="keyword" placeholder="Masukkan kata kunci" value="{{ $keyword = "unta, ternak" }}"/>
                  </div>
                  <div class="mb-3">
                    <label for="image">Gambar</label>
                    <div id="imagePreviewGambar">
                      <a href="../../../img/asus.jpg" data-fancybox>
                        <img src="../../../img/asus.jpg" class="rounded" style="margin-bottom: 0.8rem; height: 200px; max-height: 300px;"/>
                      </a>
                    </div>
                    <div id="currentDivGambar"></div>
                    <input type="file" class="form-control" id="image" name="image" style="padding: 0.2rem" onchange="return fileValidation('image', 'imagePreviewCover')"/>
                  </div>
                  <div class="mb-3">
                    <label for="konten">Konten</label>
                    <textarea class="form-controls" id="editor" name="content">{{ $content = "<h2>Definisi Unta</h2>" }}</textarea>
                  </div>
          ...
          if (!allowedExtensions.exec(filePath)) {
              ...
              if (fileInput.files && fileInput.files[0]) {
                  ...
                  reader.onload = function(e) {
                      ...
                      document.getElementById('imagePreviewGambar').innerHTML = `
