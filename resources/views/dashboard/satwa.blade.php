      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div id="boxSumatra" class="card-2 shadow mb-4 bg-white" style="border-bottom-left-radius: 0.35rem; border-bottom-right-radius: 0.35rem">
              <div class="card-header py-3 d-flex align-items-center">
                <h6 class="m-0 font-weight-bold text-success">
                  Data Satwa Sumatra
                </h6>
                <a href="/dashboard/satwa/tambah-satwa" class="btn btn-success ml-3">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="sumatraDataTables" width="100%" cellspacing="0">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      <tr class="align-middle">
                        <td class="align-middle text-gray-600" style="max-width: 10rem; min-width: 10rem">Kakatua Raja</td>
                        <td class="align-middle text-gray-600" style="max-width: 20rem; min-width: 20rem">Papua, Pulau Salawati, dan Pulau Yapen</td>
                        <td class="align-middle text-gray-600">Rentan</td>
                        <td class="align-middle text-gray-600">-</td>
                        <td class="align-middle text-gray-600" style="max-width: 6rem; min-width: 6rem">Papua</td>
                        <td class="d-flex align-middle">
                          <div class="d-flex">
                            <!-- Button Trigger-->
                            <a href="/dashboard/satwa/edit-satwa/id" class="btn btn-info d-flex justify-content-center align-items-center mr-1" style="width: 30px; height: 30px">
            ...
            <div id="boxJawa" class="card-2 shadow mb-4 d-none bg-white" style="border-bottom-left-radius: 0.35rem; border-bottom-right-radius: 0.35rem">
              <div class="card-header py-3 d-flex align-items-center">
                <h6 class="m-0 font-weight-bold text-success">
                  Data Satwa Jawa
                </h6>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="jawaDataTables" width="100%" cellspacing="0">
                    <thead>
                      <tr>
                        <th class="border-0 text-gray-700">Nama</th>
                        <th class="border-0 text-gray-700">Habitat</th>
            ...
            <div id="boxKalimantan" class="card-2 shadow mb-4 d-none bg-white" style="border-bottom-left-radius: 0.35rem; border-bottom-right-radius: 0.35rem">
              <div class="card-header py-3 d-flex align-items-center">
                <h6 class="m-0 font-weight-bold text-success">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="kalimantanDataTables" width="100%" cellspacing="0">
                    <thead>
                      <tr>
                        <th class="border-0 text-gray-700">Nama</th>
                        <th class="border-0 text-gray-700">Habitat</th>
            ...
            <div id="boxSulawesi" class="card-2 shadow mb-4 d-none bg-white" style="border-bottom-left-radius: 0.35rem; border-bottom-right-radius: 0.35rem">
              <div class="card-header py-3 d-flex align-items-center">
                <h6 class="m-0 font-weight-bold text-success">
                  Data Satwa Sulawesi
                </h6>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="sulawesiDataTables" width="100%" cellspacing="0">
                    <thead>
                      <tr>
                        <th class="border-0 text-gray-700">Nama</th>
                        <th class="border-0 text-gray-700">Habitat</th>
            ...
            <!-- DataTales Laporan Ditolak -->
            <div id="boxPapua" class="card-2 shadow mb-4 d-none bg-white" style="border-bottom-left-radius: 0.35rem; border-bottom-right-radius: 0.35rem">
              <div class="card-header py-3 d-flex align-items-center">
                <h6 class="m-0 font-weight-bold text-success">
                  Data Satwa Papua
                </h6>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="papuaDataTables" width="100%" cellspacing="0">
                    <thead>
                      <tr>
                        <th class="border-0 text-gray-700">Nama</th>
                        <th class="border-0 text-gray-700">Habitat</th>
                    ...
                    <tbody>
                      @for ($i = 0; $i < 5; $i++)
                      <tr class="align-middle">
                        <td class="align-middle text-gray-600" style="width: 10rem">Kakatua Raja</td>
                        <td class="align-middle text-gray-600" style="width: 20rem">Papua, Pulau Salawati, dan Pulau Yapen</td>
                        <td class="align-middle text-gray-600">Rentan</td>
                        <td class="align-middle text-gray-600">-</td>
                        ...
                        <td class="d-flex align-middle">
                          <div class="d-flex">
                            <!-- Button Trigger-->
                            <a href="/dashboard/laporan/detail-laporan/id" class="btn btn-info d-flex justify-content-center align-items-center mr-1" style="width: 30px; height: 30px">
                              <i class="fa-solid fa-pen" style="font-size: 0.8rem"></i>
                            </a>
                            <button type="button" href="#" class="btn btn-danger d-flex justify-content-center align-items-center"  data-bs-toggle="modal" data-bs-target="#deleteLaporan" style="width: 30px; height: 30px">
                              <i class="fa-solid fa-trash" style="font-size: 0.8rem"></i>
            ...
            <!-- DataTales Laporan Ditolak -->
            <div id="boxAllIslands" class="card-2 shadow mb-4 d-none bg-white" style="border-bottom-left-radius: 0.35rem; border-bottom-right-radius: 0.35rem">
              <div class="card-header py-3 d-flex align-items-center">
                <h6 class="m-0 font-weight-bold text-success">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="allIslandsDataTables" width="100%" cellspacing="0">
                    <thead>
                      <tr>
                        <th class="border-0 text-gray-700">Nama</th>
                        <th class="border-0 text-gray-700">Habitat</th>
