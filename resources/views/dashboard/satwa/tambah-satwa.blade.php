            ...
            <div class="card shadow mb-4">
              ...
              <form action="" method="">
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="general-name" name="general-name" placeholder="Masukkan nama umum"/>
                      </div>
                    </div>
                    <div class="col">
                      <div class="mb-3">
                        <label for="scientific-name">Nama Ilmiah</label>
                        <input type="text" class="form-control" id="scientific-name" name="scientific-name" placeholder="Masukkan nama ilmiah"/>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="habitat" name="habitat" placeholder="Masukkan habitat"/>
                        </div>
                      </div>
                    </div>
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="population" name="population" placeholder="Masukkan populasi"/>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" id="treats" name="treats" rows="6" placeholder="Jelaskan ancaman" required></textarea>
                  </div>
                  <div class="mb-3">
                    <label for="description">Deskripsi</label>
                    <textarea class="form-control" id="description" name="description" rows="6" placeholder="Jelaskan deskripsi" required></textarea>
                  </div>
                  <div class="mb-3">
                    <label for="backdrop">Backdrop</label>
                    <div id="backdropPreviewCover"></div>
                    <input type="file" class="form-control" id="backdrop" name="backdrop" style="padding: 0.2rem" onchange="return fileValidation('backdrop', 'backdropPreviewCover')"/>
                  </div>
                  <div class="mb-3">
                    <label for="poster">Poster</label>
                    <div id="posterPreviewCover"></div>
                    <input type="file" class="form-control" id="poster" name="poster" style="padding: 0.2rem" onchange="return fileValidation('poster', 'posterPreviewCover')"/>
                  </div>
